import torch
from transformers import BertTokenizerFast, RobertaTokenizerFast, BartTokenizerFast, AutoTokenizer, DistilBertTokenizerFast
import os
...
class BertConfig(object):
    ...
    # prompt_folder = "/home/yingjie_niu/Year_1/PromptQA/"
    # base_path = prompt_folder+'data/Domain_without_duplicate_CausalQAdataset/{}_template/'.format(template)
